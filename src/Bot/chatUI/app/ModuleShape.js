...
ModuleShape = draw2d.shape.layout.VerticalLayout.extend({

	NAME: "ModuleShape",
	
    init : function(attr)
    {
    	this._super($.extend({bgColor:"#dbddff", color:"#d7d7d7", stroke:1, radius:3},attr));
     ...
     setPersistentAttributes : function(memento)
     {
         ...
         if(typeof memento.entities !== "undefined"){
             $.each(memento.entities, $.proxy(function(i,e){
                    var entity =this.addEntity(e.text,i);
                    entity.id = e.id;
                    entity.getInputPort(0).setName("input_"+entity.id);
