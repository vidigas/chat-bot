...
SpreaderShape = draw2d.shape.layout.VerticalLayout.extend({

	NAME: "SpreaderShape",
	
    init : function(attr)
    {
    	this._super($.extend({bgColor:"#ffffff", color:"#d7d7d7", stroke:1, radius:3},attr));
     ...
     */
    addEntity: function(txt, optionalIndex,input=false)
    {
